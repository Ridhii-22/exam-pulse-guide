...
export const chapters: Record<string, string[]> = {
  physics: ["Kinematics", "Laws of Motion", "Work, Energy & Power", "Rotational Motion", "Thermodynamics", "Oscillations", "Waves", "Electrostatics", "Current Electricity", "Magnetism", "EMI & AC", "Optics", "Modern Physics"],
  chemistry: ["Atomic Structure", "Chemical Bonding", "Thermodynamics", "Equilibrium", "Redox Reactions", "Hydrocarbons", "Haloalkanes", "Alcohols & Phenols", "Aldehydes & Ketones", "Amines", "Biomolecules", "Coordination Compounds", "p-Block Elements"],
  biology: ["Cell Structure", "Biomolecules", "Cell Cycle", "Plant Physiology", "Human Physiology", "Reproduction", "Genetics", "Evolution", "Human Health", "Biotechnology", "Ecology", "Biodiversity"],
};

export const lectures = [
  { id: "l1", subject: "Physics", chapter: "Thermodynamics", title: "First Law & Internal Energy", duration: "42:18", progress: 100 },
  { id: "l2", subject: "Physics", chapter: "Thermodynamics", title: "Heat Engines & Carnot Cycle", duration: "38:02", progress: 65 },
  { id: "l3", subject: "Chemistry", chapter: "Coordination Compounds", title: "Werner's Theory & IUPAC Nomenclature", duration: "51:30", progress: 30 },
  { id: "l4", subject: "Biology", chapter: "Genetics", title: "Mendel's Laws & Inheritance", duration: "47:12", progress: 0 },
];
